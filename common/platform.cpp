...
OIDN_NAMESPACE_BEGIN
  ...
  #if defined(OIDN_ARCH_X64) || (defined(OIDN_ARCH_ARM64) && defined(_MSC_VER))
  ...
  #if defined(__x86_64__) || defined(_M_X64) || defined(__ia64__) || defined(__aarch64__) || defined (_M_ARM64)
    name += " (64-bit)";
  #else
    name += " (32-bit)";
  #endif
