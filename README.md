...
dielectric hits, to avoid noise. The reflected albedo can be used for
...
mapping to preserve as much detail as possible.
...
symmetric about \(0\) (i.e. normals mapped to \([0, 1]\) are *not*
acceptable and must be remapped to e.g. \([-1, 1]\)).
