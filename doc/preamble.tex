...
\definecolor{IntelDarkBlue}{RGB}{0,60,113}

\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={Intel Corporation},
            pdftitle={Intel® Open Image Denoise \oidnversion},
            colorlinks=true,
            citecolor=IntelDarkBlue,
            urlcolor=IntelDarkBlue,
            linkcolor=IntelDarkBlue,
            pdfborder={0 0 0}}

\copyrightyears{2018--2021}
